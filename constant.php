...
class Constant {
    ...
    const HINT_INVALID_TOKEN = 'Token不合法';
    ...
    const CODE_NO_COURSE = 418;
    const HINT_NO_COURSE = '未找到该课程';

    const CODE_NO_STUDENT = 418;
    const HINT_NO_STUDENT = '未找到该学生';

    const CODE_SUCCESS = 600;
    const HINT_LOGIN_SUCCESS = '登录成功';
    const HINT_LOGOUT_SUCCESS = '退出登录成功';
    const HINT_QUERY_SUCCESS = '查询成功';
}
