...
use kq\kq\Department;
use kq\kq\DepartmentQuery;
...
class DepartmentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'kq.kq.Map.DepartmentTableMap';
     ...
     */
    const OM_CLASS = '\\kq\\kq\\Department';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'kq.kq.Department';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Pid', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'pid', ),
        self::TYPE_COLNAME       => array(DepartmentTableMap::COL_ID, DepartmentTableMap::COL_NAME, DepartmentTableMap::COL_PID, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'pid', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Pid' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'pid' => 2, ),
        self::TYPE_COLNAME       => array(DepartmentTableMap::COL_ID => 0, DepartmentTableMap::COL_NAME => 1, DepartmentTableMap::COL_PID => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'pid' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(DepartmentTableMap::COL_PID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \kq\kq\Department) { // it's a model object
