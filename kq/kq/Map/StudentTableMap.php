...
class StudentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'kq.kq.Map.StudentTableMap';
     ...
     */
    const OM_CLASS = '\\kq\\kq\\Student';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'kq.kq.Student';
     ...
     */
    const COL_GENDER = 'student.gender';

    /**
     * the column name for the department_id field
     */
    const COL_DEPARTMENT_ID = 'student.department_id';

    /**
     * the column name for the class_number field
     */
    const COL_CLASS_NUMBER = 'student.class_number';

    /**
     * the column name for the card_number field
     */
    const COL_CARD_NUMBER = 'student.card_number';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Gender', 'DepartmentId', 'ClassNumber', 'CardNumber', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'gender', 'departmentId', 'classNumber', 'cardNumber', ),
        self::TYPE_COLNAME       => array(StudentTableMap::COL_ID, StudentTableMap::COL_NAME, StudentTableMap::COL_GENDER, StudentTableMap::COL_DEPARTMENT_ID, StudentTableMap::COL_CLASS_NUMBER, StudentTableMap::COL_CARD_NUMBER, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'gender', 'department_id', 'class_number', 'card_number', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Gender' => 2, 'DepartmentId' => 3, 'ClassNumber' => 4, 'CardNumber' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'gender' => 2, 'departmentId' => 3, 'classNumber' => 4, 'cardNumber' => 5, ),
        self::TYPE_COLNAME       => array(StudentTableMap::COL_ID => 0, StudentTableMap::COL_NAME => 1, StudentTableMap::COL_GENDER => 2, StudentTableMap::COL_DEPARTMENT_ID => 3, StudentTableMap::COL_CLASS_NUMBER => 4, StudentTableMap::COL_CARD_NUMBER => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'gender' => 2, 'department_id' => 3, 'class_number' => 4, 'card_number' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\kq\\kq\\Student');
        $this->setPackage('kq.kq');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('id', 'Id', 'VARCHAR', true, 14, null);
        ...
        $this->addColumn('class_number', 'ClassNumber', 'INTEGER', true, null, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(StudentTableMap::COL_GENDER);
            $criteria->addSelectColumn(StudentTableMap::COL_DEPARTMENT_ID);
            $criteria->addSelectColumn(StudentTableMap::COL_CLASS_NUMBER);
            $criteria->addSelectColumn(StudentTableMap::COL_CARD_NUMBER);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.gender');
            $criteria->addSelectColumn($alias . '.department_id');
            $criteria->addSelectColumn($alias . '.class_number');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \kq\kq\Student) { // it's a model object
