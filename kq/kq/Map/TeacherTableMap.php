...
class TeacherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'kq.kq.Map.TeacherTableMap';
     ...
     */
    const OM_CLASS = '\\kq\\kq\\Teacher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'kq.kq.Teacher';
     ...
     */
    const COL_PWD = 'teacher.pwd';

    /**
     * the column name for the phone field
     */
    const COL_PHONE = 'teacher.phone';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Pwd', 'Phone', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'pwd', 'phone', ),
        self::TYPE_COLNAME       => array(TeacherTableMap::COL_ID, TeacherTableMap::COL_NAME, TeacherTableMap::COL_PWD, TeacherTableMap::COL_PHONE, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'pwd', 'phone', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Pwd' => 2, 'Phone' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'pwd' => 2, 'phone' => 3, ),
        self::TYPE_COLNAME       => array(TeacherTableMap::COL_ID => 0, TeacherTableMap::COL_NAME => 1, TeacherTableMap::COL_PWD => 2, TeacherTableMap::COL_PHONE => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'pwd' => 2, 'phone' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TeacherTableMap::COL_PWD);
            $criteria->addSelectColumn(TeacherTableMap::COL_PHONE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \kq\kq\Teacher) { // it's a model object
