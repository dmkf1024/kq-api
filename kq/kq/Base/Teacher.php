...
abstract class Teacher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\kq\\kq\\Map\\TeacherTableMap';
    ...
    /**
     * Initializes internal state of kq\kq\Base\Teacher object.
     */
     ...
     * @return $this|\kq\kq\Teacher The current object (for fluent API support)
     */
    ...
    public function setPwd($v)
    {
        ...
        if ($this->pwd !== $v) {
            $this->pwd = $v;
            $this->modifiedColumns[TeacherTableMap::COL_PWD] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[TeacherTableMap::COL_PHONE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TeacherTableMap::translateFieldName('Pwd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pwd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TeacherTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = TeacherTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\kq\\kq\\Teacher'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TeacherTableMap::COL_PWD)) {
            $modifiedColumns[':p' . $index++]  = 'pwd';
        }
        if ($this->isColumnModified(TeacherTableMap::COL_PHONE)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\kq\kq\Teacher The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TeacherTableMap::COL_PWD)) {
            $criteria->add(TeacherTableMap::COL_PWD, $this->pwd);
        }
        if ($this->isColumnModified(TeacherTableMap::COL_PHONE)) {
            $criteria->add(TeacherTableMap::COL_PHONE, $this->phone);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \kq\kq\Teacher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \kq\kq\Teacher Clone of current object.
     * @throws PropelException
     */
