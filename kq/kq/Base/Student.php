...
abstract class Student implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\kq\\kq\\Map\\StudentTableMap';
    ...
    /**
     * The value for the class_number field.
     *
     * @var        int
     */
    protected $class_number;
    ...
    /**
     * Initializes internal state of kq\kq\Base\Student object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [class_number] column value.
     *
     * @return int
     */
     ...
     * @return $this|\kq\kq\Student The current object (for fluent API support)
     */
    ...
    public function setGender($v)
    {
        ...
        if ($this->gender !== $v) {
            $this->gender = $v;
            $this->modifiedColumns[StudentTableMap::COL_GENDER] = true;
        }
    ...
    public function setDepartmentId($v)
    {
        ...
        if ($this->department_id !== $v) {
            ...
            $this->modifiedColumns[StudentTableMap::COL_DEPARTMENT_ID] = true;
        }
    ...
    /**
     * Set the value of [class_number] column.
     *
     * @param int $v new value
     * @return $this|\kq\kq\Student The current object (for fluent API support)
     */
    public function setClassNumber($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->class_number !== $v) {
            $this->class_number = $v;
            $this->modifiedColumns[StudentTableMap::COL_CLASS_NUMBER] = true;
        }
    ...
    public function setCardNumber($v)
    {
        ...
        if ($this->card_number !== $v) {
            $this->card_number = $v;
            $this->modifiedColumns[StudentTableMap::COL_CARD_NUMBER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StudentTableMap::translateFieldName('Gender', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gender = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : StudentTableMap::translateFieldName('DepartmentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->department_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : StudentTableMap::translateFieldName('ClassNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->class_number = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : StudentTableMap::translateFieldName('CardNumber', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\kq\\kq\\Student'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StudentTableMap::COL_GENDER)) {
            $modifiedColumns[':p' . $index++]  = 'gender';
        }
        if ($this->isColumnModified(StudentTableMap::COL_DEPARTMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'department_id';
        }
        if ($this->isColumnModified(StudentTableMap::COL_CLASS_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'class_number';
        }
        if ($this->isColumnModified(StudentTableMap::COL_CARD_NUMBER)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'department_id':
                        ...
                        break;
                    case 'class_number':
                        $stmt->bindValue($identifier, $this->class_number, PDO::PARAM_INT);
                        break;
                    case 'card_number':
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setClassNumber($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setCardNumber($arr[$keys[5]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\kq\kq\Student The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StudentTableMap::COL_GENDER)) {
            $criteria->add(StudentTableMap::COL_GENDER, $this->gender);
        }
        if ($this->isColumnModified(StudentTableMap::COL_DEPARTMENT_ID)) {
            $criteria->add(StudentTableMap::COL_DEPARTMENT_ID, $this->department_id);
        }
        if ($this->isColumnModified(StudentTableMap::COL_CLASS_NUMBER)) {
            $criteria->add(StudentTableMap::COL_CLASS_NUMBER, $this->class_number);
        }
        if ($this->isColumnModified(StudentTableMap::COL_CARD_NUMBER)) {
            $criteria->add(StudentTableMap::COL_CARD_NUMBER, $this->card_number);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \kq\kq\Student (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setClassNumber($this->getClassNumber());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \kq\kq\Student Clone of current object.
     * @throws PropelException
     */
